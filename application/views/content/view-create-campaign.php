...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="col-sm-12 col-lg-6 col-md-6 col-xs-12 panel-group m-bot20" id="accordion">
            <div class="panel panel-primary row" >
                ...
                <section class="panel panel-content panel-collapse collapse in" id="setup_send_campaign" >
                    ...
                    <form class="form-horizontal" id="set_emails_to_q" method="post" action="<?php base_url(); ?>set_emails_to_queue">
                            ...
                            <div class="col-sm-10">
                                <select id="template_name" name="template_name" class="form-control input-sm" required="required">
                                    ...
                                    <?php foreach ($template_data as $template) { ?>
                                        <option value="<?php echo $template[2] . "|" . $template[3]; ?>"><?php echo $template[2]; ?></option>
                                    <?php } ?>  
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select id="list_name" name="list_name[]" multiple class="input-sm form-control" size="4" required="required">
                                    <option selected="selected"></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="input-sm form-control" id="campaign_subject" placeholder="Please provide the email subject" 
                                       required="required" name="campaign_subject" value="">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="input-sm form-control" id="camp_sender_name" placeholder="Please provide the sender name" 
                                       required="required" name="camp_sender_name" value="">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <section style="background:peachpuff;color:black ;margin:auto;padding-top:5px">
                    ...
                    <form class="form-inline col-sm-12" role="form" action="test_email_campaign" method="post" id="test_campaign_form">
                        <input class="col-sm-6 input-sm form-control" type="email" id="test_email" 
                               placeholder="Please provide an email-id to test" name="test_email">
                        <input type="button" class="col-sm-6 col-sm-offset-2 input-sm btn btn-space" id="test_send_button" Value="Click to test email" >
                    </form>
                    <br><br>
                    <br>
                </section>
