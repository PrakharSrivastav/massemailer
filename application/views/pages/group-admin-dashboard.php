...
<html lang="en">
    ...
    <body>
        ...
        <section id="container" class="">
            ...
            //echo $logged_in , $user_role;
            if ($logged_in && $user_role === '2') {
                //echo "hi";
                $this->load->view("template/view-header");
                $this->load->view("template/view-group-admin-sidebar");
                //$this->load->view("content/view-group-admin-dashboard");
                $this->load->view("content/view-assign-user-quota");
            } else {
        ...
        <script src="<?php echo base_url(); ?>resources/js/jquery.sparkline.js"></script>
        <script src="<?php echo base_url(); ?>resources/js/jquery.sparkline-11.js"></script>  
        -->
    </body>
</html>
