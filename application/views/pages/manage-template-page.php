    ...
    <body>
        ...
        <section id="container" class="">
            ...
            if ($logged_in && $user_role === '1') {
                ...
                $this->load->view("content/view-manage-template");
        ...
        <script>
            $(function () {
                $(".delete").click(function () {
                    return confirm("Do you really want to delete the selected template ?");
                });
            });
            jQuery("#template_content section  a").click(function (e) {
                //alert("hello");
