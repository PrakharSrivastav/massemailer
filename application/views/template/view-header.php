...
<header class="header dark-bg">
	...
	<div >
		<span class="pull-left" id="welcome-note" style="color:yellow">
			<h4>
				<i class="fa fa-clock-o"> </i>  : <?php $dt = new DateTime(); echo $dt->format("Y-m-d H:i:s"); ?> 
				<small style="color:yellow">Refresh to see the current time</small>
			</h4>
		</span>
	</div>
</header>
